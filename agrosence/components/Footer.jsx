...
const Footer = () => {
  ...
  return (
    <footer className="text-white py-5 w-100" style={{ backgroundColor: "#252525" }}>
        ...
        <div className="row ">
          ...
          <div className="col-md-4 mb-4">
            <div className="d-flex align-items-center mb-3">
              ...
              />
              <h5 className="fw-bold logoname mt-auto" style={{ color: "#D1D1D1" }}>AgroSense</h5>
            </div>
            <p style={{ color: "#D1D1D1" }}>
              AgroSense is dedicated to revolutionizing agriculture with innovative technology, empowering farmers for a sustainable future.
            </p>
          </div>
  {/* Contact Info */}
